...
use Software\TicketBundle\Entity\Imagen;
use Software\TicketBundle\Form\ImagenType;
...
class ImagenController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TicketBundle:Imagen')->findAll();

        return $this->render('TicketBundle:Imagen:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('TicketBundle:Imagen:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TicketBundle:Imagen')->find($id);
        ...
        return $this->render('TicketBundle:Imagen:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TicketBundle:Imagen:edit.html.twig', array(
            'entity'      => $entity,
